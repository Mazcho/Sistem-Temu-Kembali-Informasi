...
def recommend_similar_movies(input_film_title):
    ...
    for film in urutan_kemiripan_film:
        ...
        if i < 7:
            if i == 1:
                recommended_movies.append('Film anda ditemukan: ' + judul_dari_index)
                recommended_movies.append("=====================================")
                recommended_movies.append("5 rekomendasi film yang serupa dengan " + judul_dari_index)
                i += 1
            else:
                recommended_movies.append(str(i - 1) + '. ' + judul_dari_index)
                i += 1
